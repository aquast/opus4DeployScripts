...
Checkout all files into your newly created OPUS4 BASEDIR BEFORE installing OPUS via install_ubuntu.sh (e.g. /var/local/opus) 

h1. Usage

# Start OPUS4 Installation as described in the documentation
## Create BASEDIOR for new OPUS Instance
## Download and extract OPUS4 tgz into the BASEDIR
# Add module to the already extracted OPUS4 Instance
## Copy or checkout all files from this module into the OPUS4 Instance 
## run via shell
<code>
configure.sh
</code>
# Continue with standard OPUS-Insrtallation process at:
bc. cd install
./install_ubuntu.sh
